...
#print("Reading nepalitimes.json and generating embeddings...")
    #print("creating new database...")

with open('nepalitimes.json', 'r', encoding='utf-8') as f:
...
print(f"\nQuestion: {query}")
#print(f"Answer: {answer['completion']}")
print(f"Retrieved Context: {results['documents'][0]}")
...
while True:
    ...
    query_embed = remote_client.embed(model='nomic-embed-text', input=f"search_query: {usr_input}")['embeddings'][0]
